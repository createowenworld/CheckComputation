...
var InitiatePieChart = function () {
    return {
        init: function () {
            ...
            var data = [
            	{ label: "东区", data: [[1, 10]], color: themefifthcolor },
            	{ label: "西区", data: [[1, 30]], color: themesecondary },
            	{ label: "北区", data: [[1, 90]], color: themethirdcolor },
            	{ label: "南区", data: [[1, 70]], color: themefourthcolor },
            	{ label: "新郑市", data: [[1, 80]], color: themeprimary }
            ];
...
var InitiateHorizonalChart = function () {
    return {
        init: function () {
            ...
            var my_data = [[1,5, 0], [2,6, 1], [3,5, 2], [4,2, 3], [5,8, 4]];

            // Setup labels for use on the Y-axis  
            var tickLabels = [[0, '其他工程'], [1, 'XX工程'], [2, '顶管工程'], [3, '管道工程'], [4, '传输工程']];
