(function() {
    ...
    function ja(a) {
        ...
        c = a.A.m.offsetWidth,
        d; (d = b === a.s.serif && c === a.s["sans-serif"]) || (d = S() && ka(a, b, c));
    ...
    var ra = "assets/webfont/1.6.16/css.css";
    function sa(a, b) {
        for (var c = b.length,
        d = 0; d < c; d++) {
            var e = b[d].split(":");
    ...
    qa.prototype.d = function() {
        ...
        b = [], c = 0; c < a; c++) b.push(this.o[c].replace(/ /g, "+"));
    ...
    W.prototype.B = function(a) {
        var b = this.a;
        var ReturnUrl = v(this.a) + (this.c.api || "//f.fontdeck.com/s/css/js/") + (b.k.location.hostname || b.F.location.hostname) + "/" + a + ".js"
		return ReturnUrl;
    };
    ...
    Aa.prototype.load = function(a) {
        ...
        var l = [];
        b = 0;
        for (c = e.length; b < c; b++) if (d = e[b].split(":"), d[1]) for (var h = d[1].split(","), k = 0; k < h.length; k += 1) l.push(new E(d[0], h[k]));
